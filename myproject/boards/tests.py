...
class BoardTopicsTests(TestCase):
    def setUp(self):
        Board.objects.create(name='Django',description='django baord.')
...
class NewTopicTests(TestCase):
    ...
    def test_new_topic_view_containts_link_back_to_board_topics_view(self):
        new_topic_url = reverse('new_topic', kwargs={'pk':1})
        board_topics_url = reverse('board_topics', kwargs={'pk':1})
    ...
    def test_new_topic_invaliv_post_data_empty_fields(self):
        '''
